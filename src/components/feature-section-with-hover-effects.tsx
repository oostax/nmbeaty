...
export function FeaturesSectionWithHoverEffects() {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4  relative z-10 py-4 w-full px-4">
...
const Feature = ({
  ...
  return (
    <div
      className={cn(
        "flex flex-col lg:border-r  py-4 relative group/feature",
    ...
    >
          ...
          {index >= 4 && (
            <div className="opacity-0 group-hover/feature:opacity-100 transition duration-200 absolute inset-0 h-full w-full bg-gradient-to-b from-neutral-100 to-transparent pointer-events-none" />
              ...
              <div className="mb-2 relative z-10 px-8 text-neutral-600">
        {icon}
      </div>
      ...
      <p className="text-xs text-neutral-600 max-w-lg relative z-10 px-8">
        {description}
      </p>
    </div>
  );
