      ...
      >
       ...
       >
        <LaurelWreath />
           ...
           <div
             className={cn(
               "mt-1 mb-0.5 inline-block rounded-md px-1 py-0.5 tracking-wider text-white text-xs",
           ...
           {/* Main Title */}
           <h1 className={cn("text-sm font-black tracking-tight text-white")}>{title}</h1>

           {/* Decorative Line */}
           <div className="bg-white mx-auto my-0.5 h-[1px] w-12"></div>

           {/* Subtitle */}
           <h2 className={cn("mb-1 w-24 text-xs font-light text-white")}>{subtitle}</h2>

           {/* Recipient */}
           {recipient && (
             <p className={cn("text-white/60 italic text-xs")}>{recipient}</p>
           )}

           {/* Date */}
           <div className={cn("text-xs font-bold text-white")}>{date}</div>
         </div>
      </div>
    )
  }
